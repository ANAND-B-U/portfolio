...
const Portfolio = () => {
  return (
    // Pure black background for the whole section
    <div 
      className="w-full py-16 px-4 md:px-10 lg:px-24 bg-black" 
      id="portfolio"
    >
      {/* Header - Matching the "04 TECH STACK" style exactly */}
      <div className="mb-16 max-w-6xl mx-auto">
        <div className="flex items-center gap-4">
          <span className="text-[#8b5cf6] font-mono text-lg font-bold">03</span>
          <h2 className="text-gray-200 text-sm tracking-[0.25em] font-semibold uppercase">
            Selected Work
          </h2>
